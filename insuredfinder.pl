  #!/usr/bin/perl
    ...
    system('cls');
    system('title INSURED INSECURITY TOOL');
     
    print"\n";
    print "----------------------------------------------------------------------\n" ;
    print "                        INSURED INSECURITY TOOLKIT \n" ;
    print "                        InsuredFinder by: Dan Blanco\n" ;
    print "                        Enjoy\n\n" ;
    print "-----------------------------------------------------------------------\n" ;
    print "\n";
     
    print " Coloca el website a scanear \n";
    print" ejemplo: www.pagina.com o www.pagina.com/directorio \n";
    print" -> ";
    $site=<STDIN>;
    chomp $site;
     
    print "\n\n";
    print " Coloca el source en que quieres buscar el admin \n";
    print" puede ser en: asp, php, cfm, any\n";
    print" si no sabes el lenguaje coloca ** any ** \n";
    print"--> ";
    $code=<STDIN>;
    chomp($code);
    ...
    print "->La pagina: $site\n";
    print "->El source del admin: $code\n";
    print "->Scaneo en proceso...............\n\n\n";
    ...
    'adm/index.php','adm.php','affiliate.php','adm_auth.php','memberadmin.php','administratorlogin.php','wp-admin.php','administrator/','cpanel','controlpanel'
    );
    ...
    kill("STOP",NULL);
     ...
     print " \n Gracias Por usar nuestro Cpanel Finder, visita nuestra pagina www.insuredinsecurity.tk........\n"
    ##